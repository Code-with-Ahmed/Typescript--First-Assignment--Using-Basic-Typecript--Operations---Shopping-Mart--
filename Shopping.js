...
let wellcomeMessage = "WELL TO MY SUPERMART";
...
const Menu = async () => {
    ...
    let Menuu = ["Fruits", "Vegetables", "Bakery", "Checkout\n"];
...
const Fruits = async () => {
    //Display fruit Menu.
    console.log("\n Fruits Items List:");
    let fruitsList = ["Apple", "Orange", "Grapes\n"];
...
const Vegetables = async () => {
    ...
    let vegetablesList = ["Carrot", "Patato", "Spinach\n"];
